-- Prosedyren endrer navn på serier i kpi_matvarer_analyse.db og overfører verdier fra gamle serier til nye. 
-- Laget av IAO 2012.01.17
PROCEDURE $COPY_1
...
BLOCK 
	...
	try
		open<acc s>"$HOME/mytest/kpi_matvarer_analyse" as analyse
	otherwise
		type lasterror
		return
	end try
